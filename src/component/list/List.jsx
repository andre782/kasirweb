...
const Icon = ({ nama }) => {
  ...
  if (nama === "Minuman") return <FontAwesomeIcon icon={faCoffee} style={{ marginLeft: "-5px" }}/>;
        ...
        <ListGroup>
          {categories &&
            categories.map((category) => (
              ...
              className={categoriYangDipilih === category.nama && "category-aktif"} style={{cursor: "pointer"}}>
                <h5>
